                                            ...
                                            <div class="waves-carousel">
                                                <div class="tw-owl-item">
                                                    <div class="carousel-thumbnail waves-thumbnail">
                                                        ...
                                                        <p class="pServices">Llega a tus contactos de forma instantánea, donde quiera que esten e independientemente de si están usando un smartphone o un teléfono regular.</p><br />
                                                        <div id="MyBtnplace">
                                                            <div id="MyBtn">
                                                                <a href="sms.html" class="TextBlank" title="Ver Más">Ver más</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tw-owl-item">
                                                    <div class="carousel-thumbnail waves-thumbnail">
                                                        ...
                                                        <p class="pServices">Envía mensajes sin limites de contenido y fáciles de compartir a través de uno de los medios de marketing mas costo-efectivo que existe.</p><br />
                                                        <div id="MyBtnplace">
                                                            <div id="MyBtn">
                                                            <a href="email.html" class="TextBlank" title="Ver Más">Ver más</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tw-owl-item">
                                                    <div class="carousel-thumbnail waves-thumbnail">
                                                        ...
                                                        <p class="pServices">Genera diálogos con textos, imágenes, audios y videos, y sin limites de caracteres a traves del servicio de mensajería instantanea por excelencia.</p><br />
                                                        <div id="MyBtnplace">
                                            ...
                                            <div class="waves-carousel">
                                                ...
                                                <div class="tw-owl-item">
                                                    <div class="carousel-thumbnail waves-thumbnail">
                                                        ...
                                                        <p class="pPlataform">Nuestros ejecutivos estan disponibles para ayudarte cuando así lo necesites.</p>
                                                    </div>
                                                </div>
                                                <div class="tw-owl-item">
                                                    <div class="carousel-thumbnail waves-thumbnail">
