...
class ConnectusController{
	...
	*/
	public function sendMail($nombre_remitente, $email_remitente, $destinatario, $asunto, $mensaje, $connectusKey, $id_empresa, $momento_envio, $is_predefinido,$id_envio_programado = '' ){				   
		$response = array();
		...
		//if ($this->checkCreditosDisponibles($id_empresa,$consumo)) {
			...
			if ($momento_envio == 'ahora') {
				...
				$id_mensaje = $this->addMail($asunto, htmlspecialchars($mensaje, ENT_QUOTES) , $nombre_remitente, $email_remitente, $is_predefinido, $id_empresa);
	...
	* @return retorna response de mailgun con parametros -> id y message
	*/
	public function sendMailRest($nombre_remitente, $email_remitente, $destinatario, $asunto, $mensaje, $id_empresa){				   
		$response = array();
		$equivalentes = $this->getEquivalencia('equivalencia_mail');
		...
		if ($this->checkCreditosDisponibles($id_empresa,$consumo)) {
			$id_mensaje = $this->addMail($asunto, htmlspecialchars($mensaje, ENT_QUOTES) , $nombre_remitente, $email_remitente, 0, $id_empresa);
	...
	* @return retorna response de mailgun con parametros -> id y message
	*/
	public function sendMassMail($nombre_remitente, $email_remitente, $result = array(), $asunto, $mensaje, $connectusKey, $id_lista, $is_predefinido, $titulo, $id_empresa, $momento_envio, $id_envio_programado = ''){
	    ...
	    //if ($this->checkCreditosDisponibles($id_empresa,$consumo)) {
			...
			$id_mensaje = $this->addMail($titulo,  htmlspecialchars($mensaje, ENT_QUOTES)  ,$nombre_remitente, $email_remitente, $is_predefinido, $id_empresa);
