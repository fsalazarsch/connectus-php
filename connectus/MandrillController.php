...
class MandrillController{
	...
	*/
	public function sendMail($nombre_remitente, $email_remitente, $destinatario, $asunto, $message, $connectusKey, $id_empresa, $momento_envio,$is_predefinido ,$id_envio_programado = '', $nombre_predefinido = null, $nombre_envio = null ){				   
		$response = array();
		...
		//if ($this->checkCreditosDisponibles($id_empresa,$consumo)) {
			...
			if ($momento_envio == 'ahora') {
				...
				$id_envio = $this->addEnvio('en proceso' ,$nombre_remitente,$email_remitente,'' ,$id_mensaje,'unico','MAIL',$nombre_envio, $is_predefinido, $id_empresa, $asunto );			
	...
	*/
	public function sendMailRest($nombre_remitente, $email_remitente, $destinatario, $asunto, $message, $id_empresa, $nombre_predefinido = null, $nombre_envio = null ){				   
		...
		if ($this->checkCreditosDisponibles($id_empresa,$consumo)) {
			...
			$id_envio = $this->addEnvio('en proceso' ,$nombre_remitente,$email_remitente,'' ,$id_mensaje,'API','MAIL',$nombre_envio, 0, $id_empresa, $asunto);			
	...
	public function addEnvio($estado ,$remitente,$correo_remitente,$id_lista, $id_mensaje,$tipo_envio,$tipo_mensaje,$nombre_envio, $correos_malos,$id_empresa, $asunto = null){			
