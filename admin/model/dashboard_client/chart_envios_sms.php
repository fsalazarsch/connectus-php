<?php
class ModelDashboardClientChartEnviosSms extends Model {
	...
	public function getTotalOrdersByDay($id_empresa) {		
		...
		$query = $this->admDB->query("SELECT COUNT(*) AS total, HOUR(cuando_enviar) AS hour FROM detalle_envio AS D inner join envio as E
                ...
                WHERE  E.tipo_mensaje = 'SMS' and E.id_empresa = ". $id_empresa." AND E.tipo_mensaje = 'SMS' AND DAY(E.cuando_enviar) = DAY(NOW()) GROUP BY HOUR(E.cuando_enviar) ORDER BY E.cuando_enviar ASC");
	...
	public function getTotalOrdersByWeek($id_empresa) {		
		...
		$query = $this->admDB->query("SELECT COUNT(*) AS total, WEEKDAY(cuando_enviar) AS week FROM detalle_envio AS D inner join envio as E
                on E.id_envio = D.id_envio                
                WHERE  E.tipo_mensaje = 'SMS' and E.id_empresa = ". $id_empresa." AND E.tipo_mensaje = 'SMS' AND MONTH(E.cuando_enviar) = MONTH(NOW()) GROUP BY WEEKDAY(E.cuando_enviar) ORDER BY E.cuando_enviar ASC");
	...
	public function getTotalOrdersByMonth($id_empresa) {		
		...
		$query = $this->admDB->query("SELECT COUNT(*) AS total, DAY(cuando_enviar) AS day FROM detalle_envio AS D inner join envio as E
                on E.id_envio = D.id_envio                
                WHERE  E.tipo_mensaje = 'SMS' and E.id_empresa = ". $id_empresa." AND E.tipo_mensaje = 'SMS' AND MONTH(E.cuando_enviar) = MONTH(NOW()) GROUP BY DAY(E.cuando_enviar) ORDER BY E.cuando_enviar ASC");
	...
	public function getTotalOrdersByYear($id_empresa) {		
		...
		$query = $this->admDB->query("SELECT COUNT(*) AS total, MONTH(cuando_enviar) AS month FROM detalle_envio AS D inner join envio as E
                on E.id_envio = D.id_envio                
                WHERE  E.tipo_mensaje = 'SMS' and E.id_empresa = ". $id_empresa." AND E.tipo_mensaje = 'SMS' AND YEAR(E.cuando_enviar) = YEAR(NOW()) GROUP BY MONTH(E.cuando_enviar) ORDER BY E.cuando_enviar ASC");
