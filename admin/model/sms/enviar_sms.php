...
class ModelSmsEnviarSms extends Model {
	...
	public function addSmsEnvioProgramado($estado ,$remitente, $id_mensaje, $tipo_envio, $tipo_mensaje, $nombre_envio,$id_usuario ,$fecha_ejecucion ,$datos_envio_programado, $id_lista = ''){     
