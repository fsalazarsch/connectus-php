...
class ControllerCommonLogin extends Controller {
	...
	protected function validate() {
		if (!isset($this->request->post['username']) ||	!isset($this->request->post['password']) ||	!$this->user->login(	$this->request->post['username'], $this->request->post['password']))
		{
		...
		}else
			{
				...
				if($this->comprobarTokenRegistro($this->request->post['username']))
				{
    ...
    public function comprobarTokenRegistro($username)
    {
    	$this->load->model('user/valid');
    	$this->model_user_valid->setName($username);
 		return $this->model_user_valid->isValid();
    }
}