<?php
class ControllerCommonDashboardClient extends Controller {
	public function index() {
		...
		$data['chart'] = $this->load->controller('dashboard/chart_envios');

		$data['activity'] = $this->load->controller('dashboard/activity');
		$data['recent'] = $this->load->controller('dashboard/recent');
		$data['footer'] = $this->load->controller('common/footer');

		$data['sms'] = $this->load->controller('dashboard/sms');
		$data['emails'] = $this->load->controller('dashboard/emails');
		$data['contactos'] = $this->load->controller('dashboard/contactos');
		...
		$this->response->setOutput($this->load->view('common/dashboard_client.tpl', $data));
	}
}