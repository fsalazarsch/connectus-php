<?php
class ControllerMailingCrearEditarPredefinido extends Controller {
	private $error = array();

	public function index() {
        $this->load->language('mailing/crear_editar_predefinido');        
	...
	public function getForm() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('mailing/crear_editar_predefinido', 'token=' . $this->session->data['token'], 'SSL')
		);
        ...
        if (isset($this->request->get['id_mensaje'])) {           
	        ...
	        $result_preferidos = $this->model_mailing_lista_mails_predefinidos->getMailPredefinidosPorID($this->request->get['id_mensaje']);
		...
		$data['cancel'] = $this->url->link('mailing/lista_mails_predefinidos', 'token=' . $this->session->data['token'], 'SSL');	
		$data['action']	= $this->url->link('mailing/crear_editar_predefinido/add', 'token=' . $this->session->data['token'], 'SSL');	

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');		

		$this->response->setOutput($this->load->view('mailing/crear_editar_predefinido.tpl', $data));	
	}
	...
	public function editar() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('mailing/crear_editar_predefinido/editar', 'token=' . $this->session->data['token'].'&id_mensaje='.$this->request->get['id_mensaje'], 'SSL')
		);
		...
		$data['cancel'] = $this->url->link('mailing/lista_mails_predefinidos', 'token=' . $this->session->data['token'], 'SSL');	
		$data['action']	= $this->url->link('mailing/crear_editar_predefinido/update', 'token=' . $this->session->data['token'], 'SSL');	
	...
	public function add() {		
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {		 	
		 	...
		 	$this->model_mailing_lista_mails_predefinidos->addMail(($this->request->post['nombre_mensaje_predefinido']), ($this->request->post['cuerpo']), '', '', 1, $this->session->data['id_empresa']);
		 	$this->session->data['success'] = $this->language->get('text_success_crear');

		 	$this->response->redirect($this->url->link('mailing/lista_mails_predefinidos','token=' . $this->session->data['token'],'SSL'));	
		 }		
	...
	public function update() {	
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {		 	
			...
			$this->load->language('mailing/crear_editar_predefinido');		
		 	...
		 	$this->model_mailing_lista_mails_predefinidos->updateMensaje($this->request->post['nombre_mensaje_predefinido'], $this->request->post['cuerpo'], $this->session->data['id_mensaje']);		 	
