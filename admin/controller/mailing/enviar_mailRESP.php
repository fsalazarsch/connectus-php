					...
					$is_predefinido  = 0;
				 	...
				 	if ($this->model_mailing_enviar_mail->checkCreditosDisponibles($this->session->data['id_empresa'] , $consumo)) {
				 		...
				 		if ($modo_envio == 'ahora') {			 	
					 		...
					 		if($api->sendMail($this->request->post['nombre_remitente'], $this->request->post['email_remitente'], $destinatario, $asunto, $message, 'connectusKey',$this->session->data['id_empresa'], 'ahora',$is_predefinido, null, $titulo, $nombre_envio)){
					        ...
					        $result = $this->model_mailing_enviar_mail->addMailEnvioProgramado('pendiente' ,$this->request->post['nombre_remitente'] ,$this->request->post['email_remitente'],'', $id_mensaje,'unico','MAIL', $nombre_envio, $is_predefinido ,$this->session->data['id_empresa'] ,$fecha_envio.' '. $hora_envio, json_encode($datos_envio_programado, JSON_UNESCAPED_UNICODE));							
					 	...
					 	if ($result != '') {
					 		...
					 		if ($modo_envio == 'ahora') {
								...
								$id_mensaje = $this->model_mailing_enviar_mail->addMail($titulo, ($this->request->post['mensaje_a_enviar'])  ,$this->request->post['nombre_remitente'] ,$this->request->post['email_remitente'], $is_predefinido, $this->session->data['id_empresa'], null, $titulo, $nombre_envio);
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        #$asunto
						        $result = $this->model_mailing_enviar_mail->addMailEnvioProgramado('pendiente' ,$this->request->post['nombre_remitente'] ,$this->request->post['email_remitente'],$id_lista, $id_mensaje,'masivo','MAIL',$nombre_envio, 0 ,$this->session->data['id_empresa'] ,'', json_encode($datos_envio_programado, JSON_UNESCAPED_UNICODE));							
						        ...
						        $result = $this->model_mailing_enviar_mail->addMailEnvioProgramado('pendiente' ,$this->request->post['nombre_remitente'] ,$this->request->post['email_remitente'],$id_lista, $id_mensaje,'masivo','MAIL',$nombre_envio, 0 ,$this->session->data['id_empresa'] ,$fecha_envio.' '. $hora_envio, json_encode($datos_envio_programado, JSON_UNESCAPED_UNICODE));							
