...
<div id="content">
  ...
  <div class="container-fluid" align="center">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-3 col-sm-6"><?php echo $sms; ?></div>
      <div class="col-lg-4 col-md-3 col-sm-6"><?php echo $emails; ?></div>
      <div class="col-lg-4 col-md-3 col-sm-6"><?php echo $contactos; ?></div>
    </div>
    <div class="row">
