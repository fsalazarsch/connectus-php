...
<!--
<link rel="apple-touch-icon" sizes="57x57" href="view/image/apple-icon-57x57.png">
  <link rel="apple-touch-icon" sizes="60x60" href="view/image/apple-icon-60x60.png">
  <link rel="apple-touch-icon" sizes="72x72" href="view/image/apple-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="76x76" href="view/image/apple-icon-76x76.png">
  <link rel="apple-touch-icon" sizes="114x114" href="view/image/apple-icon-114x114.png">
  <link rel="apple-touch-icon" sizes="120x120" href="view/image/apple-icon-120x120.png">
  <link rel="apple-touch-icon" sizes="144x144" href="view/image/apple-icon-144x144.png">
  <link rel="apple-touch-icon" sizes="152x152" href="view/image/apple-icon-152x152.png"> 
  <link rel="apple-touch-icon" sizes="180x180" href="view/image/apple-icon-180x180.png">
  <link rel="icon" type="image/png" sizes="192x192"  href="view/image/android-icon-192x192.png">
  <link rel="icon" type="image/png" sizes="32x32" href="view/image/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="96x96" href="view/image/favicon-96x96.png">
...
<link rel='apple-touch-icon' type='images/png' href='/img/icon.57.png'> <!-- iPhone -->
<link rel='apple-touch-icon' type='images/png' sizes='72x72' href='/img/icon.72.png'> <!-- iPad -->
<link rel='apple-touch-icon' type='images/png' sizes='114x114' href='/img/icon.114.png'> <!-- iPhone4 -->
...
<link rel='apple-touch-icon' type='images/png' sizes='114x114' href='/img/icon.114.png'> <!-- iPhone4 -->
  ...
  <meta name="msapplication-TileImage" content="view/image/ms-icon-144x144.png">
...
<script type="text/javascript" src="view/javascript/bootstrap/js/bootstrap-waitingfor.js"></script>
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <a href="<?php echo $home; ?>" class="navbar-brand">  <img class="nav_logo<?php if (!$logged) { ?>_login<?php } ?>" src="<? if(($image == "") ||(!$image)) echo "view/image/connectus_logo.png";else echo "http://connectus.cl/image/".$image ?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
  <ul class="nav pull-right">
    
   <!--<li ><a href="<?php echo $ayuda;?>" target="_blank"><i class='fa fa-youtube fa-lg'></i></a></li>-->
