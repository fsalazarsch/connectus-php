...
<div id="content">
    ...
    <div class="form-center">
        ...
        <div class="divcenter">
            ...
            <div class="display-margin row">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <textarea maxlength="160" name="mensaje_a_enviar" id="mensaje-area" placeholder="<?php echo $placeholder_mensaje_a_enviar ?>" class="input-mensaje"><?php echo $mensaje_a_enviar ?></textarea>
			...
			$("#mensaje-area").focusout(function(){
			var str = $("#mensaje-area").val();
            var message = str;
            ...
            $("#mensaje-area").val(message);
            $("#mensaje-area").html(message);
			});
                ...
                document.getElementById("mensaje-area").onkeyup = function () {
                    ...
                    //console.log(document.getElementById("mensaje-area").innerHTML);
