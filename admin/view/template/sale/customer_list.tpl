...
<div id="content">
  ...
  <div class="container-fluid">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><!--<?php if ($customer['approve']) { ?>
                    ...
                    <a id='btn_edit_driver' data-toggle="modal" data-target='#modal_edit_driver' title="<?php echo $button_edit_driver; ?>" class="btn btn-warning" data-cliente='<?php echo $customer['customer_id']; ?>'><i class="fa fa-cogs"></i></a>
                    ...
                    <a href="index.php?route=sale/customer/modoEmpresa&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>" data-toggle="tooltip" title="Entrar como <?php echo $customer['name'];?>" class="btn btn-success"><i class="fa fa-home"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id='modal_edit_driver'>
        <input type='hidden' id='cliente_seleccionado'>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id='nombre_cliente'></h4>
                </div>
                
                <div class="modal-body">
                    <div class="form-group">
                        <label for="driver_mail">Driver envío MAIL</label>
                        <select id='driver_mail' class="form-control">
                            <option value='0'>Seleccione</option>
                        </select>
                    </div>
                    
                    <div class="form-group">
                        <label for="driver_sms">Driver envío SMS</label>
                        <select id='driver_sms' class="form-control">
                            <option value='0'>Seleccione</option>
                        </select>
                    </div> 
                    ...
                    <div class="form-group">                        
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" id='chk_failover'> Failover SMS
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id='btn_update_driver'>Guardar cambios</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
...
<script type="text/javascript" src="view/javascript/clientes.js"></script>
