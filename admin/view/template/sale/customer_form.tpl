...
<div id="content">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-ip" data-toggle="tab"><?php echo $tab_ip; ?></a></li>
             <?php if ($tipo == 'administrador') { ?>
              <li><a href="#tab-carga" data-toggle="tab"><?php echo "Cargar créditos"; ?></a></li> 
            <?php } ?>
          ...
          <div class="tab-content">
                  ...
                  <div class="tab-content">
                    ...
                    <?php } else{ ?>
                      ...
                      <!--Mostrar creditos-->  
                          ...
                          <label class="col-sm-2 control-label" >Cred. Mail Restantes</label>
                          <div class="col-sm-10">
                            <input type="text" readonly="true" name="firstname" value="<?php echo $mail_rest; ?>" id="input-mail" class="form-control" />
                          </div>
                        </div>  

                        <div class="form-group">
                          <label class="col-sm-2 control-label" >Cred. SMS Restantes</label>
                          <div class="col-sm-10">
                            <input type="text" readonly="true" name="firstname" value="<?php echo $sms_rest; ?>" id="inp-mail" class="form-control" />
                          </div>
                        </div>              
                      ...
                      <?php } else{ ?>
                        ...
                        <label class="col-sm-2 control-label" for="input-firstname"><?php echo $entry_firstname; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="firstname" readonly="true" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-firstname" class="form-control" />
                          <?php if ($error_firstname) { ?>
                          <div class="text-danger"><?php echo $error_firstname; ?></div>
                          <?php } ?>
                        </div>
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-lastname"><?php echo $entry_lastname; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="lastname" readonly="true" value="<?php echo $lastname; ?>" placeholder="<?php echo $entry_lastname; ?>" id="input-lastname" class="form-control" />
                          <?php if ($error_lastname) { ?>
                          <div class="text-danger"><?php echo $error_lastname; ?></div>
                          <?php } ?>
                        </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="direccion"><?php echo $entry_direccion; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="direccion" value="<?php echo $direccion; ?>" placeholder="<?php echo $entry_direccion; ?>" id="direccion" class="form-control" />
                          <?php if ($error_direccion) { ?>
                          <div class="text-danger"><?php echo $error_direccion; ?></div>
                          <?php } ?>
                        </div>
                      </div>  

                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="comuna"><?php echo $entry_comuna; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="comuna" value="<?php echo $comuna; ?>" placeholder="<?php echo $entry_comuna; ?>" id="comuna" class="form-control" />
                          <?php if ($error_comuna) { ?>
                          <div class="text-danger"><?php echo $error_comuna; ?></div>
                          <?php } ?>
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="ciudad"><?php echo $entry_ciudad; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="ciudad" value="<?php echo $ciudad; ?>" placeholder="<?php echo $entry_ciudad; ?>" id="ciudad" class="form-control" />
                          <?php if ($error_ciudad) { ?>
                          <div class="text-danger"><?php echo $error_ciudad; ?></div>
                          <?php } ?>
                        </div>
                      </div>  
            ...
            <div class="tab-pane" id="tab-carga">
              <div class="row">
	                <!--controles para muestra de creditos restantes-->
	                <div class="col-xs-10">
		                  <div class="form-group">
		                    <label class="col-sm-3 control-label" for="input-credmail"><?php echo "Cred. Mail restantes"; ?></label>
		                    <div class="col-sm-9">
		                     <input type="text" name="cmailr" value="<?php echo $mail_rest; ?>" id="input-cmailr" class="form-control" readonly="true" />
		                    </div>
		                  </div>
		                  <div class="form-group">
		                    <label class="col-sm-3 control-label" for="input-mailrec"><?php echo "Mail a cargar:"; ?></label>
		                    <div class="col-sm-9">
		                     <input type="number" name="mailrec" value="<?php echo $mailr; ?>" id="input-mail" class="form-control" />
		                    </div>
		                  </div>		                  
	                  </div>
	                  <div class="col-xs-2">
	                  <h1 id='addmail'style='color:#009099;font-weight:bold;'></h1>
	                  <i class='fa fa-envelope'></i>
		              </div>

		               <div class="col-xs-10">
		                  <div class="form-group">
	                    <label class="col-sm-3 control-label" for="input-credsms"><?php echo "Cred. SMS restantes"; ?></label>
	                     <div class="col-sm-9">
	                     <input type="text" name="csmsr" value="<?php echo $sms_rest; ?>" id="input-csmsr" class="form-control" readonly="true" />
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label class="col-sm-3 control-label" for="input-smsrec"><?php echo "SMS a cargar"; ?></label>
	                    <div class="col-sm-9">
	                     <input type="number" name="smsrec" value="<?php echo $smsr; ?>" id="input-sms" class="form-control" />
	                    </div>
	                  </div>		                  
	                  </div>
	                  <div class="col-xs-2">
		               	<h1 id='addsms'style='color:#009099;font-weight:bold;'></h1>
  ...
  <script type="text/javascript">
 	$('input[name*=\'mailrec\']').on('keyup',function(){
 		var mailrest  = $("input[name*=\'cmailr\']").val();
	  	var mailrec = $("input[name*=\'mailrec\']").val();
	  	var total = parseInt(mailrec) + parseInt(mailrest);
	  	document.getElementById('addmail').innerHTML='';
	  	$('#addmail').append(total);
	});

	$('input[name*=\'smsrec\']').on('keyup',function(){
 		var mailrest  = $("input[name*=\'csmsr\']").val();
	  	var mailrec = $("input[name*=\'smsrec\']").val();
	  	var total = parseInt(mailrec) + parseInt(mailrest);
	  	document.getElementById('addsms').innerHTML='';
	  	$('#addsms').append(total);
	});
