...
//Database adm_connectus
$admDB = new DB(DB_DRIVER, DB_HOSTNAME_CONNECTUS, DB_USERNAME_CONNECTUS, DB_PASSWORD_CONNECTUS, DB_DATABASE_CONNECTUS);
$registry->set('admDB',$admDB);
