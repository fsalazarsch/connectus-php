...
{ 
    ...
    { 
        # Producción
        //$this->_db = new mysqli('200.73.113.158', 'connectu_connect', 'cOnNectUs_05041977_.#', 'connectu_adm_connectus'); 
        
        # Testing
        $this->_db = new mysqli('localhost', 'connectu_test', 'Connectus.2016;', 'connectu_adm_test'); 
