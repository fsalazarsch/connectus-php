<?php
class ModelSmsListaSmsPredefinidos extends Model {


public function getSmsPredefinidos($id_empresa, $data = array()){
...
public function getSmsPredefinidosPorID($id_mensaje){
    $string_connection = "mysql:host=".DB_HOSTNAME_CONNECTUS.";dbname=".DB_DATABASE_CONNECTUS;
    $conexion = new PDO($string_connection,DB_USERNAME_CONNECTUS,DB_PASSWORD_CONNECTUS);
...
public function getCountSmsPredefinidos($id_empresa){
    $string_connection = "mysql:host=".DB_HOSTNAME_CONNECTUS.";dbname=".DB_DATABASE_CONNECTUS;
    $conexion = new PDO($string_connection,DB_USERNAME_CONNECTUS,DB_PASSWORD_CONNECTUS);
...
public function addSms($titulo, $cuerpo, $remitente, $correo_remitente, $guardar, $usuario = '', $archivo = '') {
