...
class ControllerSmsEstadisticas extends Controller
{
    ...
    public function getList()
    {
        ...
        $data['btn_malos']      =  $this->url->link('sms/estadisticas', 'token=' . $this->session->data['token'] . $url . "&est=malos", 'SSL');
        ...
        $data['headers'] = array('Carrier','Confirmados','Esperando','Malos','No entregados', 'Volumen');
