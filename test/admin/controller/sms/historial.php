...
class ControllerSmsHistorial extends Controller{
    ...
    public function getList(){
        ...
        if ($tipo == 'masivo') {
            ...
            $data['headers'] = array('Fecha','Nombre','Tipo Envio','Estado','Volumen','Confirmados','Malos','No entregados','Esperando','Estadisticas');
    ...
    public function exp(){
        ...
        if ($filter_data['tipo_envio'] == "masivo") {
            $headers = array("Fecha Envio","Nombre Envio","Tipo", "Estado","Volumen","Malos","No entregados","Confirmados","Esperando");            
