...
(function (factory) {
  ...
  var Editor = function () {
    ...
    this.insertImage = function ($editable, sUrl, filename) {
        ...
        var input_url   = $(".note-image-url2").val();

        async.createImage(sUrl, filename).then(function ($image) {

            // si solo existe un archivo o una url setamos la variable como false
            var agrega_url = false;

            // si existe un archivo y una url, dejamos la variable como true
            // para agregar a la imagen un link
            if(input_url != ''){
                var agrega_url = true;
            }
            ...
            if(agrega_url){
                // creamos un elemento (a) le damos como href la URL
                var a = document.createElement("a");
                    a.setAttribute('href',input_url);
    ...
    var tplDialogs = function (lang, options) {
      var tplImageDialog = function () {
        var body =
                   ...
                   '<br><br><h5>Agrege un link para la imagen</h5>' +
                   '<input class="note-image-url2 form-control span12" type="text" />' +
                   '<p class="bg-info">Escriba el link antes de seleccionar el archivo.</p>';
