...
<div id="content">
        ...
        <div>
            <div class="row" >
                <div class="form-inline">
                    ...
                    <input type="text" name="filter_username" value="<?php echo $filter_username; ?>" placeholder="<?php echo $entry_username; ?>" id="input-name" class="input-text" />
                    <?php if ($tipo_usuario == 'administrador') { ?>
                      <input type="text" name="filter_empresa" value="<?php echo $filter_empresa; ?>" placeholder="<?php echo $column_empresa; ?>" id="input-name" class="input-text" />
                    <?php } ?>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'username') { ?>
                    ...
                    <?php if ($tipo_usuario == 'administrador') { ?>
                    <td><label><?php echo $column_empresa; ?></label></td>                    
                    <?php } ?>                  
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php if ($tipo_usuario == 'administrador') { ?>
                    <td class="text-left"><?php echo $user['empresa']; ?></td>
                  <?php } ?>                  
  ...
  <script type="text/javascript"><!--
        $('#button-filter').on('click', function() {
            ...
            var filter_name = $('input[name=\'filter_username\']').val();

            if (filter_name) {
                url += '&filter_username=' + encodeURIComponent(filter_name);
            }

            var filter_empresa = $('input[name=\'filter_empresa\']').val();

            if (filter_empresa) {
                url += '&filter_empresa=' + encodeURIComponent(filter_empresa);
            }
