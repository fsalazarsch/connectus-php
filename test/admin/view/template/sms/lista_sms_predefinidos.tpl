...
<div id="content">
    <div class="page-header">
        ...
        <a href="<?php echo $full_excel; ?>" data-toggle="tooltip" title="<?php echo $button_exportar_excel; ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i></a>
        <!--<a href="<?php //echo $full_pdf; ?>" id="pdf" data-toggle="tooltip" title="<?php //echo $button_exportar_pdf; ?>" class="btn btn-warning"><i class="fa fa-file-pdf-o"></i></a>-->
    ...
    <script type="text/javascript"><!--
        $('#button-filter').on('click', function() {
            var url = 'index.php?route=sms/lista_sms_predefinidos&token=<?php echo $token; ?>';
    ...
    <script type="text/javascript"><!--
        $('input[name=\'filter\']').autocomplete({
            'source': function(request, response) {
                $.ajax({
                    url: 'index.php?route=sms/lista_sms_predefinidos/autocomplete&token=<?php echo $token; ?>&filter=' +  encodeURIComponent(request),
                    dataType: 'json',
