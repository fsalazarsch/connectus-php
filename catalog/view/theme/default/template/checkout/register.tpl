<div class="row">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <!--seccion agregada empresa-->
      <legend>Empresa</legend>
      <div class="form-group">
        <label class="control-label" for="input-payment-fax"><?php echo "Razón Social;"; ?></label>
        <input type="text" name="fax" value="" placeholder="<?php echo 'Assertsodt'; ?>" id="input-payment-fax" class="form-control" />
      </div>
      <div class="form-group">
        <label class="control-label" for="input-payment-fax"><?php echo 'Rut Empresa'; ?></label>
        <input type="text" name="fax" value="" placeholder="<?php echo '12.346.656-1'; ?>" id="input-payment-fax" class="form-control" />
      </div>
